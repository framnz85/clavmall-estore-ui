...
import OnlinePaymentDetails from "./payDetails/OnlinePaymentDetails";
import { getSubGrandTotal } from '../../functions/stripe';
import { createOrder } from "../../functions/order";
import { emptyUserCart } from "../../functions/user";

const OnlinePayment = ({succeeded, setSucceeded}) => {
  ...
  return (
    <>
      <div className="text-center pb-5">
        ...
        {succeeded &&
            <>
                <OnlinePaymentDetails payid={payopt.payid ? payopt.payid : ""} /><br /><br />
            </>
        }
        {!succeeded && <>
