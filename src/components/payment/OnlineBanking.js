...
import OnlineBankingDetails from "./payDetails/OnlineBankingDetails";
import { getSubGrandTotal } from '../../functions/stripe';
import { createOrder } from "../../functions/order";
import { emptyUserCart } from "../../functions/user";

const OnlineBanking = ({succeeded, setSucceeded}) => {
  ...
  return (
    <>
      <div className="text-center pb-5">
        ...
        {succeeded &&
            <>
                <OnlineBankingDetails payid={payopt.payid ? payopt.payid : ""} /><br /><br />
            </>
        }
        {!succeeded && <>
