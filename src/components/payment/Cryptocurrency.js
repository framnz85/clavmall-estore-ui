...
import CryptocurrencyDetails from "./payDetails/CryptocurrencyDetails";
import { getSubGrandTotal } from '../../functions/stripe';
import { createOrder } from "../../functions/order";
import { emptyUserCart } from "../../functions/user";

const Cryptocurrency = ({succeeded, setSucceeded}) => {
  ...
  return (
    <>
      <div className="text-center pb-5">
        ...
        {succeeded &&
            <>
                <CryptocurrencyDetails payid={payopt.payid ? payopt.payid : ""} /><br /><br />
            </>
        }
        {!succeeded && <>
