...
import BankTransferDetails from "./payDetails/BankTransferDetails";
import { getSubGrandTotal } from '../../functions/stripe';
import { createOrder } from "../../functions/order";
import { emptyUserCart } from "../../functions/user";

const BankTransfer = ({succeeded, setSucceeded}) => {
  ...
  return (
    <>
      <div className="text-center pb-5">
        ...
        {succeeded &&
            <>
                <BankTransferDetails payid={payopt.payid ? payopt.payid : ""} /><br /><br />
            </>
        }
        {!succeeded && <>
