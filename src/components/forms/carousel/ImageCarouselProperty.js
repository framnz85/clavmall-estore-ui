                        ...
                        property.name === image.carouselURL.split("/")[0]
                            ...
                            : property.type === "ant checked"
                                ...
                                : {
                                    ...
                                    value: listSelect[property.name] === image.carouselURL.split("/")[0]
                        ...
                        <div key={image.public_id}>
                            ...
                            <div style={{ margin: "0 7px 0 15px" }}>
                                <AntCheckbox
                                    inputProperty={{
                                        label: "Activate",
                                        onChange: (e) => handleActivateChange(image.public_id, e.target.checked),
                                        value: image.activation,
                                    }}
                                />
                                {`Distination URL: "${window.location.origin + "/" + image.carouselURL}"`}
                                <br />
