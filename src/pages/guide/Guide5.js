...
const Guide1 = () => {
  const guideVideos = [
    { key: "1", label: <><b>Video 1:</b> How Locations are being Established</>, vimeoId: 741872560 },
  ];
    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-md-8 bg-white mt-3 mb-5">
          ...
          <h4 style={{ margin: "20px 0" }}>Guide <CaretRightOutlined /> Establishing Locations</h4>
          <hr />
